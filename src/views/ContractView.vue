          ...
          <div class="level block" style="margin-bottom:1.5rem;">
            <div class="level-item has-text-centered">
              ...
              <div v-if="!loading">
                ...
                <p class="title">{{totalStakesStr}} QKC</p>
              </div>
            </div>
            <div class="level-item has-text-centered">
              <b-skeleton size="is-large" :active="loading"></b-skeleton>
          ...
          <div class="level block" style="margin:1rem 0;">
            <div class="level-item has-text-centered">
              ...
              <div v-if="!loading">
                ...
                <p class="title">{{userStakesStr}} QKC</p>
                <b-field>
            ...
            <div class="level-item has-text-centered">
              ...
              <div v-if="!loading">
                ...
                <p class="title">{{ userRewardsStr }}</p>
                <b-button type="is-success" @click="withdraw">WITHDRAW {{userBalanceStr}} QKC</b-button>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...
    userStakesStr() {
      return this.userStakes / 1e18;
    },
    userRewardsStr() {
      return (this.userRewards - this.userStakes) / 1e18;
    },
    userBalanceStr() {
      // const a = this.$ethers.BigNumber.from(this.userStakes);
      // const b = this.$ethers.BigNumber.from(this.userRewards);
      return this.userRewards / 1e18;
    },
    totalStakesStr() {
      return this.totalStakes / 1e18;
    },
    minerContactUrl() {
  ...
  methods: {
    async stake() {
      ...
      try {
        ...
        await this.checkTxStatus({ hash: tx });
      } catch(err) {
